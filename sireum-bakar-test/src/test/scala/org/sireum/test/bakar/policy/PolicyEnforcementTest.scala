...
class PolicyEnforcementTest extends BakarTestFileFramework[ProjectFile] {
  ...
  register(Projects.getProjects(BakarSmfProjectProvider, BakarExamplesAnchor.GNAT_2012_DIR + "/policy", true))
