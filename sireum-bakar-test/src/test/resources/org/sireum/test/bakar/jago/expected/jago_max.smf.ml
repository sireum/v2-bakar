...
{ parameter_astnum = 5; parameter_name = ((*R*) 4); parameter_subtype_mark = Integer; parameter_mode = Out }],
  ...
  (*///////////////////////////////////*)
  varNames = [(2, ("X", "ada://parameter/Max+1:11/X+1:16")); (5, ("Result", "ada://variable/Max+1:11/Result+3:4")); (4, ("R", "ada://parameter/Max+1:11/R+1:42")); (3, ("Y", "ada://parameter/Max+1:11/Y+1:29"))];
  (*////////////////////////////////////////////*)
  (* = = = (2) subprogram names map = = = *)
  (*////////////////////////////////////////////*)
  procNames = [(1, ("Max", "ada://procedure_body/Max+1:11"))];
  (*//////////////////////////////////////*)
  (* = = = (3) package names map = = = *)
  (*//////////////////////////////////////*)
  pkgNames = [];
...
declsRT = (ProcBodyDeclRT (1, 
  ...
  { parameter_astnumRT = 5; parameter_nameRT = ((*R*) 4); parameter_subtype_markRT = Integer; parameter_modeRT = Out }],
    ...
    (* = = = Procedure Body = = = *)
    (SeqRT (8,
    (AssignRT (9, (IdentifierRT (10, ((*Result*) 5) , [])), (NameRT (11, (IdentifierRT (12, ((*Y*) 3) , [])))))),
    (SeqRT (13,
    (IfRT (14, (BinOpRT (15, Greater_Than, (NameRT (16, (IdentifierRT (17, ((*X*) 2) , [])))), (NameRT (18, (IdentifierRT (19, ((*Y*) 3) , [])))) , [], [])),
      (AssignRT (20, (IdentifierRT (21, ((*Result*) 5) , [])), (NameRT (22, (IdentifierRT (23, ((*X*) 2) , [])))))),
      NullRT)
    ),
...
let Symbol_TableRT = {
  ...
  (* = = = (2) subprogram declaration map = = = *)
  (*////////////////////////////////////////////*)
  procs = [(((*Max*) 1), (0, mkprocBodyDeclRT (
 2,
  (* = = = Procedure Name = = = *)
  ((*Max*) 1),
  (* = = = Formal Parameters = = = *)
