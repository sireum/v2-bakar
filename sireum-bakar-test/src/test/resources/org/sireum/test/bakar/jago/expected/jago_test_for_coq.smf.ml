...
let Symbol_Table = {
  ...
  (*////////////////////////////////////////////*)
  procs = [(((*Test_for_Coq*) 1), (0, mkprocBodyDecl (
 2,
  (* = = = Procedure Name = = = *)
  ((*Test_for_Coq*) 1),
  (* = = = Formal Parameters = = = *)
...
(ObjDecl (13, { declaration_astnum = 14; object_name = ((*X*) 6); object_nominal_subtype = Integer; initialization_exp = None }))))))))],
  ...
  (*///////////////////////////////////*)
  varNames = [(5, ("I", "ada://variable/Test_for_Coq+4:11/I+8:4")); (4, ("Result", "ada://variable/Test_for_Coq+4:11/Result+7:4")); (3, ("N", "ada://variable/Test_for_Coq+4:11/N+6:4")); (6, ("X", "ada://variable/Test_for_Coq+4:11/X+9:4"))];
  (*////////////////////////////////////////////*)
  (* = = = (2) subprogram names map = = = *)
  (*////////////////////////////////////////////*)
  procNames = [(1, ("Test_for_Coq", "ada://procedure_body/Test_for_Coq+4:11"))];
  (*//////////////////////////////////////*)
  (* = = = (3) package names map = = = *)
  (*//////////////////////////////////////*)
  pkgNames = [];
...
declsRT = (ProcBodyDeclRT (1, 
  ...
  (ObjDeclRT (13, { declaration_astnumRT = 14; object_nameRT = ((*X*) 6); object_nominal_subtypeRT = Integer; initialization_expRT = None }))))))))],
    ...
    (SeqRT (28,
    (AssignRT (29, (IdentifierRT (30, ((*I*) 5) , [])), (LiteralRT (31, (Integer_Literal 2) , [], [])))),
...
let Symbol_TableRT = {
  ...
  (* = = = (2) subprogram declaration map = = = *)
  (*////////////////////////////////////////////*)
  procs = [(((*Test_for_Coq*) 1), (0, mkprocBodyDeclRT (
 2,
  (* = = = Procedure Name = = = *)
  ((*Test_for_Coq*) 1),
  (* = = = Formal Parameters = = = *)
