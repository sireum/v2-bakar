...
is
   ...
   -- Package relevant invariant and model function:
   --# function invariant return Boolean;
   --  = Z_Set_Size(State) in Size_Range
   --# function isFull(s: Z_Set) return Boolean;
   --  = Z_SetSize(State) = Size_Range'Last;
...
is
   ...
   -- = for all I, J in Integer range Index_Range'First .. Member_Count =>
   ...
   begin
      while I <= Member_Count and then Elem_Array (I) /= E loop
         --# assert I in Index_Range'First .. Member_Count + 1
