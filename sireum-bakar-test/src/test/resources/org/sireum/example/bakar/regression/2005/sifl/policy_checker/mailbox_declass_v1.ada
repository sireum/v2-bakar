...
--@ ordering {};
--@ INTEGER_INPUT_0_DATA, INTEGER_INPUT_0_READY in P0In;
--@ INTEGER_OUTPUT_0_DATA, INTEGER_OUTPUT_0_READY in P0Out;
--@ INTEGER_INPUT_1_DATA, INTEGER_INPUT_1_READY in P1In;
--@ INTEGER_OUTPUT_1_DATA, INTEGER_OUTPUT_1_READY in P1Out;
--@ declassify ( INTEGER_INPUT_0_DATA on true, INTEGER_INPUT_0_READY on true: P0In -> P1Out ),
--@            ( INTEGER_INPUT_1_DATA on true, INTEGER_INPUT_1_READY on true: P1In -> P0Out );
