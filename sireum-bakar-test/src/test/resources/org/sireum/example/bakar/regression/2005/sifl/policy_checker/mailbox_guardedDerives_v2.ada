...
is
  ...
  procedure MACHINE_STEP ;
    ...
    --@ derives INTEGER_OUTPUT_0_DATA from INTEGER_INPUT_1_DATA on (INTEGER_INPUT_1_READY),
    --@                                              INTEGER_OUTPUT_0_READY on true,
    --@                                              INTEGER_OUTPUT_0_DATA on ((not INTEGER_INPUT_1_READY) or INTEGER_OUTPUT_0_READY),
    --@                                              INTEGER_INPUT_1_READY on true &
    --@         INTEGER_OUTPUT_1_DATA from INTEGER_INPUT_0_DATA on (INTEGER_INPUT_0_READY),
    --@                                              INTEGER_INPUT_0_READY on true,
    --@                                              INTEGER_OUTPUT_1_DATA on ((not INTEGER_INPUT_0_READY) or INTEGER_OUTPUT_1_READY),
