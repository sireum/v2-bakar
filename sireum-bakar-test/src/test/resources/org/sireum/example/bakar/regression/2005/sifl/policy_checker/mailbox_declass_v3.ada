...
--@ ordering {};
--@ INTEGER_INPUT_0_DATA in P0In;
--@ INTEGER_OUTPUT_1_DATA, INTEGER_OUTPUT_1_READY, INTEGER_INPUT_0_READY in P1Out;
--@ INTEGER_INPUT_1_DATA in P1In;
--@ INTEGER_OUTPUT_0_DATA, INTEGER_OUTPUT_0_READY, INTEGER_INPUT_1_READY in P0Out;
--@ declassify ( INTEGER_INPUT_0_DATA on (INTEGER_INPUT_0_READY and (not INTEGER_OUTPUT_1_READY)): P0In -> P1Out ),
--@            ( INTEGER_INPUT_1_DATA on (INTEGER_INPUT_1_READY and (not INTEGER_OUTPUT_0_READY)): P1In -> P0Out );
