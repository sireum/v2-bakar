// Do not edit this file. It is auto-generated from org.sireum.bakar.policy.BakarProgramTranslator
...
object BakarProgramTranslatorModule extends PipelineModule {
  ...
  def compute(job : PipelineJob, info : PipelineJobModuleInfo) : MBuffer[Tag] = {
    ...
    try {
      val module = Class.forName("org.sireum.bakar.policy.BakarProgramTranslatorModuleDef")
  ...
  object ProducerView {
    implicit class BakarProgramTranslatorModuleProducerView (val job : PropertyProvider) extends AnyVal {
      ...
      def parseGnat2XMLresults_=(parseGnat2XMLresults : scala.collection.immutable.Map[java.lang.String, org.sireum.bakar.xml.CompilationUnit]) { BakarProgramTranslatorModule.setParseGnat2XMLresults(job.propertyMap, parseGnat2XMLresults) }
      def parseGnat2XMLresults : scala.collection.immutable.Map[java.lang.String, org.sireum.bakar.xml.CompilationUnit] = BakarProgramTranslatorModule.getParseGnat2XMLresults(job.propertyMap)
